...
! **** DIFFERENTIAL HOMOPHILY ***
	...
	if ((x(im, xcolm)==1 .and. x(jm, xcolm)==2) .or. (x(im, xcolm)==2 .and. x(jm, xcolm)==1)) dtfm = 1.0
else if (tm==32) then
	if ((x(im, xcolm)==2 .and. x(jm, xcolm)==3) .or. (x(im, xcolm)==3 .and. x(jm, xcolm)==2)) dtfm = 1.0
else if (tm==33) then
	if ((x(im, xcolm)==1 .and. x(jm, xcolm)==3) .or. (x(im, xcolm)==3 .and. x(jm, xcolm)==1)) dtfm = 1.0	
